...
def tts_f5_multi_tab(user_config: UserConfig):
    ...
    with gr.Row():
        with gr.Column(scale=4):                     
            with gr.Group():                            
                ...
                language_radio_spk1 = gr.Radio(
                    choices=voice_spk1.gradio_f5_languages(),
                    label=i18n("Language"),
                    value=user_config.get("f5_multi_language1", "English"),
                )
        ...
        with gr.Column(scale=4):                     
            with gr.Group():                            
                ...
                language_radio_spk2 = gr.Radio(
                    choices=voice_spk2.gradio_f5_languages(),
                    label=i18n("Language"),
                    value=user_config.get("f5_multi_language2", "English"),
                )
    ...
    language_radio_spk1.change(voice_spk1.gradio_change_f5_language,
                        inputs=[language_radio_spk1],
                        outputs=[celeb_voice_dropdown_spk1, model_choice])      
